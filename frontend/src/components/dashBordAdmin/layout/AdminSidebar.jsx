...
import { useState, useEffect } from 'react'; // ✅ ajout useState + useEffect
...
export default function AdminSidebar() {
  ...
  const [user, setUser] = useState(null); // ✅ state déclaré ici

  useEffect(() => {
    const fetchUser = async () => {
      const data = await getCurrentUser(); // GET /auth/me → { email, fullName, roles }
      setUser(data);
    };
    fetchUser();
  }, []);
